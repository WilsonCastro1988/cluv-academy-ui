...
@Component({
    selector: 'app-student-principal-info',
    templateUrl: './student-principal-info.component.html',
    styleUrls: ['./student-principal-info.component.scss']
})
export class StudentPrincipalInfoComponent implements OnInit {
