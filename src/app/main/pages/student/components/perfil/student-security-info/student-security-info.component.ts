...
@Component({
    selector: 'app-student-security-info',
    templateUrl: './student-security-info.component.html',
    styleUrls: ['./student-security-info.component.scss']
})
export class StudentSecurityInfoComponent implements OnInit {
