...
@Component({
    selector: 'app-user-security-info',
    templateUrl: './user-security-info.component.html',
    styleUrls: ['./user-security-info.component.scss']
})
export class UserSecurityInfoComponent implements OnInit {
